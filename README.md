...
insert into users values('paresh','paresh','Paresh','Kharche','Pune','1236547089','pareshkharche2000@gmail.com',2);
...
Step 1: Click On File > Import > Git > Projects From Git > Clone Uri > Paste The Repository Url as: ```https://github.com/pareshkharche/onlinebookstore.git```> Select master Branch > Next > Next > Finish.
...
Step 8: The default Username And Password For User Is "paresh" And "paresh"
